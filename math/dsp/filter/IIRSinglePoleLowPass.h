#ifndef K_MATH_DSP_FILTER_IIRSINGLEPOLELOWPASS_H
#define K_MATH_DSP_FILTER_IIRSINGLEPOLELOWPASS_H
...
namespace K {
	...
	public:
		...
		IIRSinglePoleLowPass() : a0(1.0), b1(0.0), out1(0.0) {
			;
		}
...
#endif // K_MATH_DSP_FILTER_IIRSINGLEPOLELOWPASS_H
